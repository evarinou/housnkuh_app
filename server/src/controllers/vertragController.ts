...
// createVertragWithZusatzleistungen wurde 2026-07-08 entfernt (AUDIT):
// toter Legacy-Endpoint POST /vendor/contracts/create ohne Client-Aufrufer,
// erzeugte Verträge mit monatspreis=0 (Phantom-Feld mietfach.preis) und
// validierte gegen ein nicht existierendes 15%-Provisionsmodell.
